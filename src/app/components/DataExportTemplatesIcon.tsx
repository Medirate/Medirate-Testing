...
interface DataExportTemplate {
  ...
  template_data: DataExportTemplateData;
  created_at: string;
  updated_at: string;
}

interface DataExportTemplatesIconProps {
  onLoadTemplate: (template: DataExportTemplateData) => void;
...
const DataExportTemplatesIcon = ({
  onLoadTemplate,
  currentSelections,
  currentStartDate,
  currentEndDate,
  currentSelectedColumns,
}: DataExportTemplatesIconProps) => {
  ...
  const fetchTemplates = async () => {
    ...
    setError(null);
    try {
      const response = await fetch("/api/dashboard-templates?page=data-export");
  ...
  const handleSaveTemplate = async () => {
    ...
    try {
      const templateData: DataExportTemplateData = {
  ...
  const handleLoadTemplate = (template: DataExportTemplate) => {
...
export type { DataExportTemplateData };
export default DataExportTemplatesIcon;
